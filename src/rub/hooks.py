...
hookspec = pluggy.HookspecMarker("rub")
hookimpl = pluggy.HookimplMarker("rub")


class RubHookSpecs:
    """Hook specifications for Rub lifecycle events.

    Plugins implement these hooks to extend Rub's behavior at key points
