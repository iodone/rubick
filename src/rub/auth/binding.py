...
from rub.auth.profile import Profile, Profiles
...
_DEFAULT_BINDINGS_PATH = Path.home() / ".config" / "rub" / "auth_bindings.json"


class AuthBindings:
    """Manages host-to-credential bindings with glob matching.

    Persists to ~/.config/rub/auth_bindings.json by default.
    """
